  ...
  return (
    <div className="min-h-screen p-6 bg-gray-100 flex items-center justify-center">
      <div className="container max-w-screen-lg mx-auto">
        <div>
          <h2 className="font-semibold text-xl text-gray-600">Profile Form</h2>
          <p className="text-gray-500 mb-6">Please fill out all the fields.</p>

          <div className="bg-white text-gray-600 rounded shadow-lg p-4 px-4 md:p-8 mb-6">
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex justify-between">
                ...
                <button type="submit" className="bg-blue-500 text-white font-bold py-2 px-4 rounded mt-5">
                  {step === 1 ? 'Next' : 'Submit'}
                </button>
              </div>
            </form>
